...
#' @param pof_despesa The df with the expenditure data. Default to load a new df.
#' @param tipo_despesa=0 The type (or types) of expenditure. Default to all expenditures.
#' @param uf="all" The relevant federal unit (numeric)
#' @param regiao="all" The relevant macrorregion (character code)
#' @return The mean deflated monthly expenditure
#' @examples 
#' calcular_valor_despesa_mensal_uc(tipo_despesa = c(0,1,2));
#' calcular_valor_despesa_mensal_uc(tipo_despesa = c(0,1,2), regiao = "N");
#' @export
